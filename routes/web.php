...
Route::name('movie.')->group(function() {
    Route::get('/', 'MovieController@getList')->name('list');
    Route::get('/movie/{movieId}', 'MovieController@getDetails')->name('details');
    Route::post('/movie/{movieId}', 'MovieController@postFavorite');
});
